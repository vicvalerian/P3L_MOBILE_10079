...
import com.vickyvaleriansende.ajr_190710079.adapters.MobilAdapter;
...
import com.vickyvaleriansende.ajr_190710079.models.MobilResponse;
...
public class MobilActivity extends AppCompatActivity {
    ...
    private void getAllMobil() {
        ...
        StringRequest stringRequest = new StringRequest(GET,
                PelangganApi.GET_ALL_MOBIL_URL, new Response.Listener<String>() {
            @Override
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuProfilPelanggan:
                Intent moveShowProfil = new Intent(MobilActivity.this, PelangganActivity.class );
                startActivity(moveShowProfil);
                return true;
            case R.id.menuPromo:
                Intent moveShowPromo = new Intent(MobilActivity.this, PromoActivity.class );
                startActivity(moveShowPromo);
                return true;
            case R.id.menuMobil:
                return true;
            case R.id.menuRiwayatPelanggan:
                Intent moveShowRiwayat = new Intent(MobilActivity.this, RiwayatTransaksiPelangganActivity.class);
