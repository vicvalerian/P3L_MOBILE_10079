...
import com.vickyvaleriansende.ajr_190710079.adapters.RiwayatTransaksiDriverAdapter;
import com.vickyvaleriansende.ajr_190710079.api.DriverApi;
import com.vickyvaleriansende.ajr_190710079.models.RiwayatTransaksiDriverResponse;
...
public class RiwayatTransaksiDriverActivity extends AppCompatActivity {
    ...
    private RiwayatTransaksiDriverAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RiwayatTransaksiDriverAdapter(new ArrayList<>(), this);
        rvRiwayat.setLayoutManager(new LinearLayoutManager(RiwayatTransaksiDriverActivity.this,
    ...
    private void getAllRiwayat() {
        ...
        StringRequest stringRequest = new StringRequest(GET,
                DriverApi.GET_ALL_DETAIL_TRANSAKSI_DRIVER_URL+ driverPreferences.getIdDriver(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Gson gson = new Gson();

                RiwayatTransaksiDriverResponse riwayatResponse = gson.fromJson(response, RiwayatTransaksiDriverResponse.class);
                adapter.setRiwayatList(riwayatResponse.getRiwayatList());
                adapter.getFilter().filter(svRiwayat.getQuery());
                Toast.makeText(RiwayatTransaksiDriverActivity.this, riwayatResponse.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuProfilDriver:
                Intent moveShowProfil = new Intent(RiwayatTransaksiDriverActivity.this, DriverActivity.class );
