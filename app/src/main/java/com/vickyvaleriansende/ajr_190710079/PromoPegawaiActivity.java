...
public class PromoPegawaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_promo_pegawai);
        ...
        rvPromo.setLayoutManager(new LinearLayoutManager(PromoPegawaiActivity.this,
    ...
    private void getAllPromo() {
        ...
        StringRequest stringRequest = new StringRequest(GET,
                PegawaiApi.GET_ALL_PROMO_URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                Toast.makeText(PromoPegawaiActivity.this, promoResponse.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                try {
                    ...
                    Toast.makeText(PromoPegawaiActivity.this, errors.getString("message"), Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(PromoPegawaiActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        }) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menuLaporanManager:
                Intent moveShowPromo = new Intent(PromoPegawaiActivity.this, PegawaiActivity.class );
